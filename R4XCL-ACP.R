...
attr(AD_ACP.C, "description") = 
  list(
        ...
        TipoOutput       = "1:Matriz de Correlación, 2:Coordenadas: Variables, 3:Coordenadas: Individuos, 4:COS^2: INDs, 5:Contribución:INDs, 6:Valores Propios, 7:COS^2: VARs, 8:Contribución:VARs, 9:Predicción, 10:Gráfico VARs|INDs", 
