...
#-------------------------->>> 
  ...
  A = dlg_list(Procedimientos$BINARIO)
  
  TipoOutput=A$res
  
  if (TipoOutput == Procedimientos$BINARIO[1]){
    ...
    OutPut = data.frame("R4XCL_ModeloEstimado"= stargazer(Modelo, 
                                                          ...
                                                          ci.level=0.95,
                                                          single.row=TRUE))
  }else if(TipoOutput == Procedimientos$BINARIO[2]){
     
    OutPut = data.frame("R4XL_PrediccionDentroDeMuestra" = Y_Pred)
     
  }else if(TipoOutput == Procedimientos$BINARIO[3]){    
  ...
  }else if(TipoOutput == Procedimientos$BINARIO[4]){ 
  ...
  }else if(TipoOutput == Procedimientos$BINARIO[8]){ 
...
attr(MR_Binario.D, DialogosXCL$Descripcion) = 
      list(
