  ...
  
{
  ...
  }else if (TipoOutput == Procedimientos$POISSON[6]){  
  ...
  }else if(TipoOutput == Procedimientos$POISSON[7]){ 
  ...
  }else if(TipoOutput == Procedimientos$POISSON[8]){ 
...
attr(MR_Poisson.D, DialogosXCL$Descripcion) <-
  list (
