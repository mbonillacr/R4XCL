...
Detalle = "Calcula el test de cointegración Phillips-Ouliaris a la Serie introducida"

attr(ST_TestCointegracion, "description" ) = 
  list( 
        Detalle,
        SetDatosX    = "Series de tiempo a las que se busca analizar cointegración",
...
Detalle = "Calcula los test de raíz unitaria de Dickey Fuller y Phillips Perron a la Serie introducida"
...
Detalle = "Calcula la Autocorrelación Serial de la Serie introducida"
